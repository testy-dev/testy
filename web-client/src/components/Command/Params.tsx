...
import { TextInput, NumberInput, SelectorInput } from "./Inputs";
import { Box, Text } from "grommet";

const params: {[cmd in CommandIds]: {[param: string]: {component: React.FunctionComponent | React.ComponentClass, label: string, helperText?: string}}} = {
  "web-open-url": {
...
const Params: React.FC<ParamsProps> = ({cmd}) => {
  ...
  for (const paramKey in activeParams) {
    ...
    items.push(
      <Box key={paramKey} direction="row" justify="stretch" align="center" gap="small">
