  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content="Record tests, run, analyse results. Without programming."
        />
      </Helmet>
      ...
      <section id="pricing" className="pt-32 lg:pb-30 lg:pt-40">
        <div className="container mx-auto text-center">
          ...
          <div className="flex flex-col justify-center sm:flex-row sm:-mx-3 mt-12">
            <div className="px-3">
              <Card className="mb-8">
                <p className="font-semibold text-2xl">$0</p>
                <p className="text-xl">First 5000 steps are free</p>
              </Card>
            </div>
            <div className="px-3">
              <Card className="mb-8">
                <p className="font-semibold text-2xl">$1 per 1000 steps</p>
                <p className="text-xl">First 5000 steps are free</p>
              </Card>
            </div>
          </div>
      ...
      <section id="features" className="pt-32 lg:pb-40 lg:pt-48">
        <div className="container mx-auto text-center">
          ...
          <div className="flex flex-col flex-wrap sm:flex-row sm:-mx-3 mt-12">
            ...
            <div className="flex-1 px-3">
              <Card className="mb-8">
                <p className="font-semibold text-xl">Tests history</p>
                <p className="mt-4">You can anytime see tests history with screenshots included.</p>
              </Card>
            </div>
          </div>
        </div>
